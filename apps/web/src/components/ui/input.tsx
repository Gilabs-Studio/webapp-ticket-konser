  ...
  ({ className, type, onFocus, onKeyDown, ...props }, ref) => {
    ...
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full border border-input bg-background px-3 py-2 text-sm font-light tracking-wide ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-light file:text-foreground placeholder:text-muted-foreground placeholder:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:border-primary/50 focus-visible:shadow-[0_0_0_3px] focus-visible:shadow-primary/10 disabled:cursor-not-allowed disabled:opacity-50 input-gradient-focus rounded-md",
          className,
        )}
        ref={ref}
        onFocus={handleFocus}
